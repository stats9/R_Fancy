...
& \exp(1) - 1 \implies \\
& \text{Cov}(U, Y) = 1 - \frac{1}{2} \times (\exp(1) - 1) = \frac{3 - \exp(1)}{2} \approx `r round((3 - exp(1))/2, 4)`
\end{aligned}
$$
...
data.frame(number_of_Iteration = num, result = result, 
                Theory_vlaue = round((3 - exp(1))/2, 6)) |> 
...
& \mathcal{E}(\exp(Y)) = \sum_{i = 1}^{10} \exp(i) \times \frac{1}{10} = \frac{1}{10}\times \sum_{i = 1}^{10} \exp(i) \approx `r round(1/10 * sum(exp(1:10)), 6)`, \\
& \mathcal{E}{Y} = \frac{1}{10}\sum_{i = 1}^{10} i = \frac{1}{10}\frac{10 \times 11}{2} = \frac{11}{2}, \\
& \mathcal{E}(Y \exp(Y)) = \frac{1}{10}\sum_{i = 1}{10} i \times \exp(i) \approx `r round(1/10 * sum(((1:10) * exp(1:10))), 6)`\\
& \text{Cov}(Y, \exp(Y)) = `r round(1/10 * sum(((1:10) * exp(1:10))), 6)` - \frac{11}{2} \times `r round(1/10 * sum(exp(1:10)), 6)` \approx `r round((1/10 * sum(((1:10) * exp(1:10)))) - (11 / 2) * (1/10 * sum(exp(1:10))), 6)`
\end{aligned}
$$
...
temp <- round((1/10 * sum(((1:10) * exp(1:10)))) - (11 / 2) * (1/10 * sum(exp(1:10))), 6)
data.frame(number_of_Iteration = num, result = result, 
                Theory_vlaue = temp) |> 
knitr :: kable(, align = "c", caption = 
                "Table of simulation Results")
