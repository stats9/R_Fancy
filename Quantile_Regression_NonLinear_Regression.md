...
lwd = rep(c(3, 5), c(5, 1)), bty = "n", cex = 1)
```
...
![](Quantile_Regression_NonLinear_Regression_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](Quantile_Regression_NonLinear_Regression_files/figure-gfm/unnamed-chunk-19-2.png)<!-- -->
